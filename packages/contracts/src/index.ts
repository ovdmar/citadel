...
const INTERACTIVE_AGENT_STATUSES: ReadonlySet<AgentSessionStatus> = new Set([
  "starting",
  "running",
  "waiting_for_input",
]);

const ALIVE_AGENT_STATUSES: ReadonlySet<AgentSessionStatus> = new Set([
  "starting",
  "running",
  "waiting_for_input",
  "rate_limited",
...
const ACCEPTING_INPUT_AGENT_STATUSES: ReadonlySet<AgentSessionStatus> = new Set([
  "starting",
  "running",
  "waiting_for_input",
  "rate_limited",
