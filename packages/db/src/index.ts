...
function normalizePrState(raw: string | null): "open" | "closed" | "merged" | null {
...
export class SqliteStore {
  ...
  // Per-workspace PR snapshot — read by the gh-scheduler on boot (hydrate)
  // so cadence state (especially merged → never-poll) survives daemon restart
