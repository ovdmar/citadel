...
import { themeFromJson } from "./ttyd-theme.js";
import type { TtydEntry } from "./ttyd-types.js";
...
function readTtydEntryFromProc(pid: number, port: number, basePathPrefix: string): TtydEntry | null {
  ...
  return { key, port, pid, basePath, tmuxSession, worktreePath: null, startedAt, theme: themeFromJson(themeJson), tabId: null };
}
