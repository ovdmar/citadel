...
[~] 7. Citadel owns session creation, metadata, workspace/runtime association, tmux lifecycle, terminal permissions, WebSocket routing, PTY attach cleanup, and tmux-client orphan reaping.
