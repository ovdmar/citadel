...
[ ] 7. Citadel still owns session creation, metadata, workspace association, optional agent-runtime association, tmux lifecycle, terminal permissions, ttyd spawn/cleanup, and proxy routing. ttyd is only the renderer.
