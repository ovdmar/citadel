...
keywords: operations, activity, audit, progress, logs, mcp, automation, agents, agent definitions, agent launchers, plan handoff, scratchpad, fuzzy search, refine, citadel actions
